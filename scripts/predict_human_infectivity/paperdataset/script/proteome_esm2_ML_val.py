...
def proteome_rf_esm2_val_paperdataset():
    # 1. 读取数据
    ...
    result_df.to_csv(f"../result/val/proteome/rf_result_esm2.csv", index=False)
    summary.to_csv(f"../result/val/proteome/rf_summary_esm2.csv")



def proteome_knn_esm2_val_paperdataset():
    dt_mapping_0 = pd.read_csv("../data/AllDataIdMapping.csv", sep="\t")
    dt_mapping_0 = dt_mapping_0[dt_mapping_0["belong"]=="861paper"].reset_index(drop=True)
    target_taxid = list(dt_mapping_0["Taxid"])
    ...
    os.makedirs("../result/val/proteome", exist_ok=True)
    top_num = X.shape[1]  # 特征数
    result_df.to_csv(f"../result/val/proteome/knn_result_esm2.csv", index=False)
    summary.to_csv(f"../result/val/proteome/knn_summary_esm2.csv")





def proteome_svm_esm2_val_paperdataset():
    dt_mapping_0 = pd.read_csv("../data/AllDataIdMapping.csv", sep="\t")
    dt_mapping_0 = dt_mapping_0[dt_mapping_0["belong"]=="861paper"].reset_index(drop=True)
    target_taxid = list(dt_mapping_0["Taxid"])
    ...
    # 保存文件
    os.makedirs("../result/val/proteome", exist_ok=True)
    result_df.to_csv(f"../result/val/proteome/svm_result_esm2.csv", index=False)
    summary.to_csv(f"../result/val/proteome/svm_summary_esm2.csv")




def proteome_xgboost_esm2_val_paperdataset():
    dt_mapping_0 = pd.read_csv("../data/AllDataIdMapping.csv", sep="\t")
    dt_mapping_0 = dt_mapping_0[dt_mapping_0["belong"]=="861paper"].reset_index(drop=True)
    target_taxid = list(dt_mapping_0["Taxid"])
    ...
    # 保存文件
    os.makedirs("../result/val/proteome", exist_ok=True)
    result_df.to_csv(f"../result/val/proteome/xgboost_result_esm2.csv", index=False)
    summary.to_csv(f"../result/val/proteome/xgboost_summary_esm2.csv")
...
if __name__ == "__main__":
    ...
    proteome_rf_esm2_val_paperdataset()
