...
def kmer_xgboost_val_hpv():
    for k in [3,4,5]:
        ...
        os.makedirs("../result/val/genome", exist_ok=True)
        result_df.to_csv(f"../result/val/genome/xgb_result_{k}mer.csv", index=False)
        summary.to_csv(f"../result/val/genome/xgb_summary_{k}mer.csv")
